...
/* Nota:
	Cuando pintar una pieza o el ojeto articulado entero, no olvides declarar:
			- el typedef enum correspondiente
			- declarar el objeto _clase instanciaClase;
			- case correspondiente en draw_objects() --> pintar el objeto
			- case correspondiente en normal_key() --> tecla para mostrar el obj

			- case correspondiente en special_key() --> para darle movimiento
*/
#include <GL/glut.h>
#include <ctype.h>
#include <math.h>
...
switch (Tecla1){
	...
	case GLUT_KEY_PAGE_DOWN:Observer_distance/=1.2;break;
			case GLUT_KEY_F1:pantenon.giro_techo+=1; //velocidad de giro
												// giro con tope
			...
			case GLUT_KEY_F7:pantenon.sube_escal+=3; // +3 es la velocidad con la que gira
			break;
			case GLUT_KEY_F8:pantenon.sube_escal+=-3;
			break;
